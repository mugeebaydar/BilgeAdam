...
public class ListArabirimi {
    ...
    public static void main(String[] args) {
        ...
        if(renkler.contains("Yeşil")){ //contains methodu var mı diye kontrol eder. equals gibi
        ...
        Iterator iterator=renkler.iterator(); //iterator listele riçinde gezebilmek için
