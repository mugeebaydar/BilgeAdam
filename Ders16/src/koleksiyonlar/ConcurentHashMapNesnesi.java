...
public class ConcurentHashMapNesnesi {
    ...
    public static void main(String[] args) {
        ...
        for(Map.Entry entry:sinifDuzeyleri.entrySet()){
            System.out.println(entry.getKey()); //2.sınıf olarak ekrana basar
            System.out.println(entry.getValue()); //2.sınıftaki değerleri döner.
            //sinifDuzeyleri.remove(entry.getKey()); //set kullanmadan veri silmek için kullanılabilir
        }
