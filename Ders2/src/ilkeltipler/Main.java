...
public class Main {
    ...
    public static void main (String [] args){
        ...
        System.out.println("Bu bir long değer: "+c);
        int x;
        x=12;
        x=7; //Her zaman en son değeri baz alır.
        ...
        Byte cByte= new Byte((byte) 20); // her değer int olarak kabul edilir. Parantez içine yazdığımız değeri byte olarak keser.
        ...
        System.out.println("Bu bir string değer: "+aString);
        String bString= new String("abcde");
        System.out.println("Bu bir string değer: "+bString);
