...
public class StreamDonusturme {
    ...
    public static void main(String[] args) {
        ...
        List<String> yeniListe = liste.stream().filter(x -> !x.isEmpty()).collect(Collectors.toList()); //collect topla demek. listeyi yenilisteye aktarma
    ...
    public static void streamKullanmasaydik(List<String> liste) {
        ...
        System.out.println("Stream API kullanmasaydık");
